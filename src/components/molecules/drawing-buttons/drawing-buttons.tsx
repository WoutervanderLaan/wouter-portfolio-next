      ...
      modalContent={
        <div className="flex w-40 flex-col gap-4 rounded-md border border-black bg-white p-4">
          ...
          <Button variant="primary" onPress={() => saveCanvas("png")}>
            <Text.Paragraph className="text-white">png</Text.Paragraph>
          </Button>
          ...
          <Button
            ...
            className="w-full"
          >
            <Text.Paragraph className="text-white">svg</Text.Paragraph>
          </Button>
        </div>
      }
    >
  ...
  return (
    <div className="relative">
      ...
      <Button
        ...
        variant="secondary"
        className={clsx(STANDARD_BUTTON_STYLING, {
          "ring-2 ring-blue-400 ring-offset-2": type === ToolType.IMAGE,
        })}
      >
        <ImageIcon />
      </Button>
