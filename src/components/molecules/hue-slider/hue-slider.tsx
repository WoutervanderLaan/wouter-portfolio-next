...
const HueSlider = ({
  ...
  const sliderPosition =
    orientation === "horizontal" ? (hue / 360) * width : (hue / 360) * height;
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        style={{
          left: orientation === "horizontal" ? sliderPosition : width / 2,
          top: orientation === "horizontal" ? height / 2 : sliderPosition,
        }}
      >
